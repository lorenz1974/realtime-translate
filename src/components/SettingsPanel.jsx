...
export default function SettingsPanel({
  ...
  return (
    <>
      <div
        className={`settings-backdrop ${open ? 'show' : ''}`}
        onClick={onClose}
      />
      <aside
      ...
      >
        ...
        <div className='settings-body'>
          ...
          <section className='mb-4'>
            <h6 className='section-title'>
              <i className='bi bi-mic-fill me-1 text-danger'></i>Microfono
            </h6>
            <div className='input-group mb-2'>
              <select
              ...
              <button
                ...
                aria-label='Aggiorna elenco dispositivi'
              >
            ...
            <div className='small text-secondary'>
              ...
              Cuffie Bluetooth, auricolari con microfono e dispositivi USB
              appaiono qui non appena connessi al sistema operativo. Se un
              dispositivo non compare, premi{' '}
              <i className='bi bi-arrow-clockwise'></i> per aggiornare l'elenco.
              Il microfono del telefono non è accessibile direttamente;
              collegalo via Bluetooth o USB audio al PC e il browser lo
              elencherà automaticamente.
            </div>
          </section>

          <section>
            <h6 className='section-title'>
              <i className='bi bi-sliders me-1 text-info'></i>Opzioni
            </h6>
            ...
            <div className='form-check form-switch mb-2'>
              ...
              <label className='form-check-label' htmlFor='opt-autoplay'>
                <i className='bi bi-volume-up me-1'></i> Riproduci audio della
                traduzione
              </label>
            </div>
            ...
            <div className='form-check form-switch mb-2'>
              <input
                ...
                type='checkbox'
                id='opt-transcribe'
                checked={transcribeInput}
                onChange={(e) => setTranscribeInput(e.target.checked)}
              />
              <label className='form-check-label' htmlFor='opt-transcribe'>
                <i className='bi bi-card-text me-1'></i> Mostra trascrizione
                sorgente
              </label>
            </div>
            ...
            <div className='form-check form-switch'>
              ...
              <label className='form-check-label' htmlFor='opt-history'>
                <i className='bi bi-clock-history me-1'></i> Mantieni cronologia
                frasi
              </label>
            </div>
          </section>
